...
are processed and requests are sent.

This makes it possible to create a UI that will allow the user to interact and possibly make changes to different or all items
...
The id of the batch can be obtained using the [useBatchAddListener](../../hooks/usebatchaddlistener)
