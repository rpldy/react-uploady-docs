...
See this guide for an illustration of how easy it is to add cropping to your Uploady based uploads.

### Lightweight

By design, React-Uploady has a small footprint with almost no 3rd party dependencies.
...
React-Uploady aims to bring you the entire file-uploading toolkit in order for you to be able to focus on your applications needs.
