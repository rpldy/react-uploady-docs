...
In addition, most UploadOptions props can be passed to UploadDropZone, in order to override configuration passed to the parent Uploady component.
See [Uploady documentation](../..#props) for detailed list of upload options.

The following [guide](../../../guides/DifferentConfiguration) shows how different upload drop zones may use different upload options.
